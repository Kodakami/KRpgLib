namespace KRpgLib.Stats
{
    ...
    public interface IStatTemplate<TValue> : ILegalizeableValue<TValue>
        where TValue : struct
    {
    ...
    /// </summary>
    public class StatTemplate_Int : AbstractStatTemplate<int>
    {
        public StatTemplate_Int(int? min, int? max, int? precision, int defaultValue)
    ...
    /// </summary>
    public class StatTemplate_Float : AbstractStatTemplate<float>
    {
        public StatTemplate_Float(float? min, float? max, float? precision, float defaultValue, int decimalsOfPrecisionForRounding)
